...
class RPCTests: XCTestCase {
    ...
    func testGetTransactionReceipt() {
        let result = appChain.rpc.getTransactionReceipt(txhash: "0xb439c647b3c3b135a30154f33026d0a7074473766cb26d6017ac9d8269559f4d")
        switch result {
    ...
    func testGetTransactionProof() {
        let result = appChain.rpc.getTransactionProof(txhash: "0xb439c647b3c3b135a30154f33026d0a7074473766cb26d6017ac9d8269559f4d")
        switch result {
    ...
    func testGetBlockHeader() {
        let result = appChain.rpc.getBlockHeader(blockNumber: "0x4cfcb")
        switch result {
